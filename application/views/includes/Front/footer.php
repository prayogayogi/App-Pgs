<footer class="ftco-footer ftco-bg-dark ftco-section img" style="background-image: url(<?= base_url('assets/FrontAssets/') ?>images/bg_2.jpg); background-attachment:fixed;">
  <div class="overlay"></div>
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-3">
        <div class="ftco-footer-widget mb-4">
          <h2><a class="navbar-brand" href="index.html"><i class="flaticon-university"></i>Smk N 05 <br><small>Kepahiang</small></a></h2>
      ...
      <div class="col-md-2">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#" class="py-2 d-block">Tik-Tok</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-3">
