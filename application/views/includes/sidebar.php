  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview <?= (current_url() == base_url('Sirkulasi/DataLahirController')) || (current_url() == base_url('Sirkulasi/DataMeninggalController')) || (current_url() == base_url('Sirkulasi/SirkulasiController/dataPendatang')) || (current_url() == base_url('Sirkulasi/SirkulasiController/dataPindah'))  ? 'menu-open ' : '' ?> ">
